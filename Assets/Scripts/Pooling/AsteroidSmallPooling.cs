...
public class AsteroidSmallPooling : MonoBehaviour, IPoolingEnemy
{
    [SerializeField] private GameObject prefab;
    [SerializeField] private List<GameObject> asteroidsList;
    [SerializeField] private int poolSize = 10;

    private static AsteroidSmallPooling instance;
    public static AsteroidSmallPooling Instance { get { return instance; } }   // lo podremos llammar desde otros scripts
    ...
    public GameObject RequestAsteroid()
    {
        ...
        {
            if (!asteroidsList[i] != null &&  !asteroidsList[i].gameObject.activeSelf)
            {
