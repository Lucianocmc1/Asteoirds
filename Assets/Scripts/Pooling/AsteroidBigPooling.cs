...
public class AsteroidBigPooling : MonoBehaviour , IPoolingEnemy
{
    [SerializeField] private GameObject prefab;
    [SerializeField] private List<GameObject> asteroidsList;
    [SerializeField] private int poolSize = 10;

    private static AsteroidBigPooling instance;
    public static AsteroidBigPooling Instance { get { return instance; } }   // lo podremos llammar desde otros scripts
